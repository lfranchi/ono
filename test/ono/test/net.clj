...
(fact "about generated handshake messages"
      (let [pd (peer-data :udp-socket nil
                          :control-connections (atom {1 :conn1 2 :conn2})
                          :dbsync-connections (atom {1 :conn1 2 :conn2}))]
        (get-handshake-msg pd 3 :control-connections "whitelist" "my-dbid") 
            =>  [2 "{\"nodeid\":\"my-dbid\",\"conntype\":\"accept-offer\",\"key\":\"whitelist\",\"port\":55555}"]
        (get-handshake-msg pd 2 :control-connections "abcdef" "my-dbid") 
            =>  [2 "{\"controlid\":\"my-dbid\",\"conntype\":\"accept-offer\",\"key\":\"abcdef\",\"port\":55555}"]))
